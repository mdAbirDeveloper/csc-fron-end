...
const hydraulicValves = () => {
  ...
  const onSubmit = async (data) => {
    ...
    for (let i = 0; i < data.images.length; i++) {
      ...
      setSubmited("hydraulicValves added successfully")
      setLoading(false);
    ...
    try {
      ...
      const response = await fetch("https://csc-server-again.vercel.app/hydraulicValves", {
        method: "POST",
        headers: {
  ...
  return (
    <div>
      <h1 className="text-3xl mt-8 text-center font-bold uppercase text-green-500">
        Add Your hydraulicValves
      </h1>
      <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
        <div className="form-control">
          <input
            type="text"
            placeholder="write your hydraulicValves old price"
        ...
        <div className="form-control">
          <input
            type="text"
            placeholder="write your hydraulicValves price"
            className="input input-bordered"
            {...register("price")}
          />
        </div>
        <div className="form-control">
          <input
            type="text"
            placeholder="write your hydraulicValves name"
            className="input input-bordered"
            required
            {...register("name")}
          />
        ...
        <label className="text-red-400">user , for give a line brack in your descriptions</label>
          <textarea
            type="text"
            placeholder="write your hydraulicValves description"
            className="input input-bordered"
            required
        ...
        <div>
          <label>Choose images of your hydraulicValves</label>
...
export default hydraulicValves;



hydraulicValves.getLayout = function getLayout(page) {
  return (
